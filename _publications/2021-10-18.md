...
excerpt: 'We developed an uncertainty-aware nonlinear model predictive controller that adjusts how strongly a companion robot trusts predicted human motion. This enables proactive following while avoiding overconfident movements that could obstruct the person or cause the robot to fall behind.'
date: 2021-10-18
...
links:
  - label: IEEE Xplore
    url: https://ieeexplore.ieee.org/document/9561974
